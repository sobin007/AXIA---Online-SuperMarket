              ...
              <div class="card-header">
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="<?php echo site_url('Category/addSubCategory');?>">Add Sub Category</a>
                    <a class="dropdown-item" href="#">Something else here</a>
                  ...
                  <thead class=" text-primary">
                    ...
                    <?php  
                     foreach ($category->result() as $row)  
                      ...
                      <td><a href="<?php echo base_url('category/viewsubcategory/' . $row->cat_id); ?>">VIEW SUBCATEGORY</a></td>
