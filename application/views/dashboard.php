	...
	<div class="agileits_header">
		<div class="container">
			...
			<div class="agile-login">
				<ul>
					<li><a href="<?php echo site_url('account/register');?>"> Create Account </a></li>
					<li><a href="<?php echo site_url('account/login');?>">Login</a></li>
					<li><a href="<?php echo site_url('account/admin');?>">Help</a></li>
...
<!-- //navigation -->
	<!-- main-slider -->
		<ul id="demo1">
			...
			<li>
				<img src="<?= base_url();?>assets/images/22.jpg" alt="" />
				  <div class="slide-desc">
			...
			<li>
				<img src="<?= base_url();?>assets/images/44.jpg" alt="" />
				<div class="slide-desc">
					<h3>Whole Spices Products Are Now On Line With Us</h3>
				</div>
			</li>
												...
												<figure>
													<div class="snipcart-item block" >
														<div class="snipcart-thumb">
															<a href="products.html"><img title=" " alt=" " src="http://localhost/code_/assets/images/1.png" /></a>		
															<p>Tata-salt</p>
															<div class="stars">
